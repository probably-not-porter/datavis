...
function processReadings(readings) {
    ...
    for (x = 0; x < spotids.length; x++) {
        ...
        if (current_data.length != 0) {
            ...
            var min = timestamps.reduce(function (a, b) {
                return a < b ? a : b;
            });
...
function createCSV() {
    const rows = [
        ["tripid", "platformid", "sensorid", "hostid", "recordtime", "value_1", "quality", "latitude", "longitude", "elevation", "accuracy", "satellites", "value_2", "value_3", "siteid", "sectorid", "value_4", "value_5", "value_6"]
    ];
